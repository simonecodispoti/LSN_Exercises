...
double variationalWaveFunction(double val)
{
	...
	//gaussian double superposition
	return exp(-pow(val-mu,2)/(2*pow(sigma,2))) + exp(-pow(val+mu,2)/(2*pow(sigma,2)));
}
...
double variationalWaveFunction_second(double val)
{
	...
	//gaussian double superposition
	return (1/pow(sigma,2))*((pow(val-mu,2)/pow(sigma,2))-1)*exp(-pow(val-mu,2)/(2*pow(sigma,2))) + (1/pow(sigma,2))*((pow(val+mu,2)/pow(sigma,2))-1)*exp(-pow(val+mu,2)/(2*pow(sigma,2)));
}
